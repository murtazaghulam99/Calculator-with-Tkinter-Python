...
btnclean = Button(cal, padx=16, bd=8, fg='black', font=('arial',20,'bold'), text="C", command = clean_screen).grid(row=4, column=1)
btnequal = Button(cal, padx=16, bd=8, fg='black', font=('arial',20,'bold'), text="=", command = equal_function).grid(row=4, column=2)
